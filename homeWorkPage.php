...
<html>
    <head>
        <meta charset="utf-8">
        <title>Cyrus' Brucker PHP Home Work</title>
        <h1>Cyrus' Brucker PHP Home Work</h1>
        <h2>Welcome to Cyrus' PHP Home Work! </h2>  
    </head>
    <body>
        ...
        <p><a href="selfPostingInputHW/selfPostingInsertFormH.php">Self posting input event with inputs, 12</p>
